...
export default function LoginScreen({ onLoginSuccess, accountsList }: LoginScreenProps) {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-slate-50 px-4 py-12 relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-72 h-72 bg-red-100/40 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-red-50/30 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-12 bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden relative z-10 animate-in fade-in-50 duration-300">
        ...
        <div className="md:col-span-5 bg-gradient-to-br from-red-750 via-red-700 to-red-800 p-8 text-white flex flex-col justify-between relative">
          {/* Subtle Merah Putih Flag Accent */}
          <div className="absolute top-0 right-0 w-24 h-6 flex">
          ...
          <div className="space-y-4 my-8">
            <div className="p-4 bg-red-950/40 rounded-2xl border border-white/10 backdrop-blur-sm text-xs leading-relaxed">
          ...
          <div className="text-[10px] text-red-200 border-t border-red-500/20 pt-4 flex items-center justify-between">
        ...
        <div className="md:col-span-7 p-8 sm:p-10 flex flex-col justify-center">
          ...
          <div className="mb-6 bg-slate-50 border border-slate-200 p-4 rounded-2xl">
            <span className="text-[10px] font-black tracking-wider text-red-700 block mb-2.5 uppercase font-display">
          ...
          <form onSubmit={handleManualLogin} className="space-y-4 mt-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-xl py-2 px-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-red-700 transition-all font-medium placeholder-slate-400 shadow-sm"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  maxLength={6}
                  className="w-full bg-white border border-slate-300 rounded-xl py-2 px-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-red-700 focus:border-red-700 transition-all font-mono font-bold placeholder-slate-400 tracking-widest shadow-sm"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              id="btn-submit-login"
              className="w-full bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-100 text-white rounded-xl py-2.5 font-bold text-sm transition-all shadow-md hover:shadow-lg transform active:scale-[0.99] cursor-pointer block text-center"
            >
